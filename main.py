...
class DiceSimScreen(Screen):
    ...
    def _build_ui(self):
        ...
        self.base_bet_in = _StyledInput(text='1')
        ...
        self.mult_input  = _StyledInput(text='2.0000')
        ...
        self._loss_pct_in = _StyledInput(text='50', size_hint_x=None, width=dp(52))
        ...
        action_row2.add_widget(Widget(size_hint_x=0.24))
        action_row2_inner = BoxLayout(size_hint_x=0.52, spacing=dp(6))
...
class MainMenu(Screen):
    ...
    def show_about(self, *args):
        if App.get_running_app() and App.get_running_app().is_presentation_mode_active():
            ...
            msg = (
                'Strategy Suite Pro is a probability and scenario analysis toolkit built to help users study risk, '
                'variance, sequence behavior, and model performance more clearly.\n\n'
                'Presentation Mode changes selected labels and visual styling for clean showcase footage while leaving '
                'all underlying calculations and license controls untouched.\n\n'
            ...
            msg = (
                ...
                'Created by SH Vertex Technologies™. Built with care by a small creator, not a huge company.\n\n\n\n'
            )
        content = BoxLayout(orientation='vertical', padding=dp(12), spacing=dp(10))
        body = Label(text=msg, color=get_color_from_hex(STAKE_TEXT), text_size=(Window.width - dp(80), None), halign='left', valign='middle')
        close_btn = StyledButton(text='CLOSE', bg_color=STAKE_GREEN, height=dp(38))
        popup = Popup(title=popup_title, content=content, size_hint=(0.88, 0.62))
        close_btn.bind(on_release=lambda *a: popup.dismiss())
