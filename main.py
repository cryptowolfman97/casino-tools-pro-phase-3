...
class MainMenu(Screen):
    ...
    def show_about(self, *args):
        if App.get_running_app() and App.get_running_app().is_presentation_mode_active():
            ...
            msg = (
                'Strategy Suite Pro is a premium presentation layer built on top of the same analytical engine inside '
                'Casino Tools Pro. It is designed for clean demos, structured walkthroughs, and educational showcase '
                'videos where risk, variance, progression logic, and simulated outcomes need to be explained clearly.\n\n'
                'Presentation Mode refines selected wording and visuals for marketing and demonstration purposes only. '
                'It does not change the underlying calculations, licensing controls, or safety principles of the app.\n\n'
